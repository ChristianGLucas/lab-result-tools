...
// testContext is a testing.T-backed axiom.Context for unit tests. Shared
// across every *_test.go file in this package — keep exactly one copy.
...
// testFlowMutation is a no-op mutation sink (this package has no mutation-capable nodes).
